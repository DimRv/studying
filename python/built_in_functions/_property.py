...
property подразумевает что перед чтением, записью или удалением должны быть выполнены какие-либо действия

@property - следующий за записью метод будет геттером
@prop.setter - следующий за записью метод будет cеттером
@prop.deleter - следующий за записью метод будет делитером
